...
static int wmt_detect_dump_pin_conf(void)
{
	...
	WMT_DETECT_PR_INFO("CMB_ALL_EINT(GPIO%d), CMB_URXD(GPIO%d), CMB_UTXD(GPIO%d)\n",
			gpio_ctrl_info.gpio_ctrl_state[GPIO_COMBO_ALL_EINT_PIN].gpio_num,
			gpio_ctrl_info.gpio_ctrl_state[GPIO_COMBO_URXD_PIN].gpio_num,
			gpio_ctrl_info.gpio_ctrl_state[GPIO_COMBO_UTXD_PIN].gpio_num);

	WMT_DETECT_PR_INFO("PCM_CLK(GPIO%d), PCM_IN(GPIO%d), PCM_OUT(GPIO%d), PCM_SYNC(GPIO%d)\n",
	...
	WMT_DETECT_PR_INFO("I2S_CK(GPIO%d), I2S_WS(GPIO%d), I2S_DATS(GPIO%d)\n",
	...
	WMT_DETECT_PR_INFO("GPS_SYNC(GPIO%d), GPS_LNA(GPIO%d), DEEP_SLEEP(GPIO%d), WAKE_UP(GPIO%d)\n",
			gpio_ctrl_info.gpio_ctrl_state[GPIO_GPS_SYNC_PIN].gpio_num,
			gpio_ctrl_info.gpio_ctrl_state[GPIO_GPS_LNA_PIN].gpio_num,
			gpio_ctrl_info.gpio_ctrl_state[GPIO_CHIP_DEEP_SLEEP_PIN].gpio_num,
			gpio_ctrl_info.gpio_ctrl_state[GPIO_CHIP_WAKE_UP_PIN].gpio_num);
