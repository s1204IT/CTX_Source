...
public:
    ...
    virtual int setSeninfCamTGMuxCtrl(SENINF_TOP_P1_ENUM camTarget, SENINF_MUX_ENUM seninfMuxSrc);
    virtual int setSeninfMuxCtrl(unsigned long Muxsel, unsigned long hsPol, unsigned long vsPol,
