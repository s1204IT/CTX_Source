...
LOCAL_SRC_FILES := \
    ...
    seninf_drv.cpp \
    secure/seninf_drv_tee.cpp

#ifeq ($(MTK_CAM_SECURITY_SUPPORT), yes)
#LOCAL_SRC_FILES += secure/seninf_drv_tee.cpp
#endif
#-----------------------------------------------------------
...
LOCAL_C_INCLUDES += $(TOP)/$(MTK_PATH_SOURCE)/hardware/mtkcam/drv/src/sensor/$(MTKCAM_DRV_PLATFORM)/secure
...
ifeq ($(strip $(MTK_CAM_MAX_NUMBER_OF_CAMERA)), 5)
    MTKCAM_CFLAGS += -DMTK_MAIN3_IMGSENSOR
endif
