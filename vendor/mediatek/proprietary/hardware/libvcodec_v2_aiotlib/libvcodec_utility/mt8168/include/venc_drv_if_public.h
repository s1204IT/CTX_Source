...
typedef enum __VENC_DRV_SET_TYPE_T {
	...
	VENC_DRV_SET_TSVC,
	VENC_DRV_SET_TYPE_NONREFP_FREQ,
	VENC_DRV_SET_TYPE_REFP_DISTANCE,
	VENC_DRV_SET_TYPE_REFP_FRMNUM,
...
typedef enum __VENC_DRV_GET_TYPE_T {
	...
	VENC_DRV_SET_TYPE_QUERY_REFBUF_FRAME_NUM,
