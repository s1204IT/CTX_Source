...
#define MTK_VDEC_PROP_WAITKEYFRAME                 "vendor.mtk.vdec.waitkeyframeforplay"
...
typedef enum _VDEC_DRV_VIDEO_FORMAT_T {
    ...
    VDEC_DRV_VIDEO_FORMAT_DIVX311               = 1,      /* /< Divix 3.11 */
    VDEC_DRV_VIDEO_FORMAT_DIVX4                 = 2,      /* /< Divix 4 */
    VDEC_DRV_VIDEO_FORMAT_DIVX5                 = 3,      /* /< Divix 5 */
    VDEC_DRV_VIDEO_FORMAT_XVID                  = 4,      /* /< Xvid */
    VDEC_DRV_VIDEO_FORMAT_MPEG1                 = 5,      /* /< MPEG-1 */
    VDEC_DRV_VIDEO_FORMAT_MPEG2                 = 6,      /* /< MPEG-2 */
    VDEC_DRV_VIDEO_FORMAT_MPEG4                 = 7,      /* /< MPEG-4 */
    VDEC_DRV_VIDEO_FORMAT_H263                  = 8,      /* /< H263 */
    VDEC_DRV_VIDEO_FORMAT_H264                  = 9,      /* /< H264 */
    VDEC_DRV_VIDEO_FORMAT_H265                  = 10,     /* /< H265 */
    VDEC_DRV_VIDEO_FORMAT_WMV7                  = 11,     /* /< WMV7 */
    VDEC_DRV_VIDEO_FORMAT_WMV8                  = 12,     /* /< WMV8 */
    VDEC_DRV_VIDEO_FORMAT_WMV9                  = 13,     /* /< WMV9 */
    VDEC_DRV_VIDEO_FORMAT_VC1                   = 14,     /* /< VC1 */
    VDEC_DRV_VIDEO_FORMAT_REALVIDEO8            = 15,     /* /< RV8 */
    VDEC_DRV_VIDEO_FORMAT_REALVIDEO9            = 16,     /* /< RV9 */
    VDEC_DRV_VIDEO_FORMAT_VP6                   = 17,     /* /< VP6 */
    VDEC_DRV_VIDEO_FORMAT_VP7                   = 18,     /* /< VP7 */
    VDEC_DRV_VIDEO_FORMAT_VP8                   = 19,     /* /< VP8 */
    VDEC_DRV_VIDEO_FORMAT_VP8_WEBP_PICTURE_MODE = 20,     /* /< VP8 WEBP PICTURE MODE */
    VDEC_DRV_VIDEO_FORMAT_VP8_WEBP_MB_ROW_MODE  = 21,     /* /< VP8 WEBP ROW MODE */
    VDEC_DRV_VIDEO_FORMAT_VP9                   = 22,     /* /< VP9 */
    VDEC_DRV_VIDEO_FORMAT_VP9_WEBP_PICTURE_MODE = 23,     /* /< VP9 WEBP PICTURE MODE */
    VDEC_DRV_VIDEO_FORMAT_VP9_WEBP_MB_ROW_MODE  = 24,     /* /< VP9 WEBP ROW MODE */
    VDEC_DRV_VIDEO_FORMAT_AVS                   = 25,     /* /< AVS */
    VDEC_DRV_VIDEO_FORMAT_MJPEG                 = 26,     /* /< Motion JPEG */
    VDEC_DRV_VIDEO_FORMAT_S263                  = 27,     /* /< Sorenson Spark */
    VDEC_DRV_VIDEO_FORMAT_HEIF                  = 28,     /* /< HEIF */
    VDEC_DRV_VIDEO_FORMAT_H264SEC               = 29,
    VDEC_DRV_VIDEO_FORMAT_H265SEC               = 30,
    VDEC_DRV_VIDEO_FORMAT_RV30                  = 31,     /* /< real video8 */
    VDEC_DRV_VIDEO_FORMAT_RV40                  = 32,     /* /< real video9,10*/
    VDEC_DRV_VIDEO_FORMAT_VP9SEC                = 33
} VDEC_DRV_VIDEO_FORMAT_T;
...
typedef enum _VDEC_DRV_H265_VIDEO_PROFILE_T {
	...
	VDEC_DRV_H265_VIDEO_PROFILE_H265_MAIN          = (1 << 0),     /* /< V4L2_MPEG_VIDEO_H265_PROFILE_MAIN H265 main profile */
	VDEC_DRV_H265_VIDEO_PROFILE_H265_MAIN_10       = (1 << 1),     /* /< V4L2_MPEG_VIDEO_H265_PROFILE_MAIN10 H265 main 10 profile */
	VDEC_DRV_H265_VIDEO_PROFILE_H265_HDR_10        = (1 << 2),     /* /< V4L2_MPEG_VIDEO_H265_PROFILE_MAIN_HDR10 H265 main 10 profile */
	VDEC_DRV_H265_VIDEO_PROFILE_H265_STILL_IMAGE   = (1 << 3)      /* /<V4L2_MPEG_VIDEO_H265_PROFILE_MAIN_STILL_PIC H265 still image profile */
} VDEC_DRV_H265_VIDEO_PROFILE_T;
...
typedef enum _VDEC_DRV_H264_VIDEO_PROFILE_T {
	...
	VDEC_DRV_H264_VIDEO_PROFILE_H264_BASELINE             = (1 << 0),   /* /<V4L2_MPEG_VIDEO_H264_PROFILE_BASELINE H264 baseline profile */
	VDEC_DRV_H264_VIDEO_PROFILE_H264_CONSTRAINED_BASELINE = (1 << 1),   /* /<V4L2_MPEG_VIDEO_H264_PROFILE_CONSTRAINED_BASELINE H264 constrained baseline profile */
	VDEC_DRV_H264_VIDEO_PROFILE_H264_MAIN                 = (1 << 2),   /* /<V4L2_MPEG_VIDEO_H264_PROFILE_MAIN H264 main profile */
	VDEC_DRV_H264_VIDEO_PROFILE_H264_EXTENDED             = (1 << 3),   /* /<V4L2_MPEG_VIDEO_H264_PROFILE_EXTENDED H264 extended profile */
	VDEC_DRV_H264_VIDEO_PROFILE_H264_HIGH                 = (1 << 4),   /* /<V4L2_MPEG_VIDEO_H264_PROFILE_HIGH H264 high profile */
	VDEC_DRV_H264_VIDEO_PROFILE_H264_HIGH_10              = (1 << 5),   /* /<V4L2_MPEG_VIDEO_H264_PROFILE_HIGH_10 H264 high 10 profile */
	VDEC_DRV_H264_VIDEO_PROFILE_H264_HIGH422              = (1 << 6),   /* /<V4L2_MPEG_VIDEO_H264_PROFILE_HIGH_422 H264 high 422 profile */
	VDEC_DRV_H264_VIDEO_PROFILE_H264_HIGH444              = (1 << 7),   /* /<V4L2_MPEG_VIDEO_H264_PROFILE_HIGH_444_PREDICTIVE H264 high 444 profile */
	VDEC_DRV_H264_VIDEO_PROFILE_H264_HIGH_10_INTRA        = (1 << 8),   /* V4L2_MPEG_VIDEO_H264_PROFILE_HIGH_10_INTRA */
	VDEC_DRV_H264_VIDEO_PROFILE_H264_HIGH422_INTRA        = (1 << 9),   /* V4L2_MPEG_VIDEO_H264_PROFILE_HIGH_422_INTRA*/
	VDEC_DRV_H264_VIDEO_PROFILE_H264_HIGH444_INTRA        = (1 << 10),  /* V4L2_MPEG_VIDEO_H264_PROFILE_HIGH_444_INTRA*/
	VDEC_DRV_H264_VIDEO_PROFILE_H264_CAVLC444_INTRA       = (1 << 11),  /* V4L2_MPEG_VIDEO_H264_PROFILE_CAVLC_444_INTRA*/
	VDEC_DRV_H264_VIDEO_PROFILE_H264_SCALABLE_BASELINE    = (1 << 12),  /* V4L2_MPEG_VIDEO_H264_PROFILE_SCALABLE_BASELINE*/
	VDEC_DRV_H264_VIDEO_PROFILE_H264_SCALABLE_HIGH        = (1 << 13),  /* V4L2_MPEG_VIDEO_H264_PROFILE_SCALABLE_HIGH*/
	VDEC_DRV_H264_VIDEO_PROFILE_H264_SCALABLE_HIGH_INTRA  = (1 << 14),  /* V4L2_MPEG_VIDEO_H264_PROFILE_SCALABLE_HIGH_INTRA*/
	VDEC_DRV_H264_VIDEO_PROFILE_H264_STEREO_HIGH          = (1 << 15),  /* V4L2_MPEG_VIDEO_H264_PROFILE_STEREO_HIGH*/
	VDEC_DRV_H264_VIDEO_PROFILE_H264_MULTIVIEW_HIGH       = (1 << 16)   /* V4L2_MPEG_VIDEO_H264_PROFILE_MULTIVIEW_HIGH*/
} VDEC_DRV_H264_VIDEO_PROFILE_T;
...
typedef enum _VDEC_DRV_MPEG_VIDEO_PROFILE_T {
	VDEC_DRV_MPEG_VIDEO_PROFILE_MPEG4_SIMPLE          = (1 << 0),   /* /<V4L2_MPEG_VIDEO_MPEG4_PROFILE_SIMPLE MPEG4 Simple Profile */
	VDEC_DRV_MPEG_VIDEO_PROFILE_MPEG4_ADVANCED_SIMPLE = (1 << 1),   /* /<V4L2_MPEG_VIDEO_MPEG4_PROFILE_ADVANCED_SIMPLE MPEG4 Advanced Simple Profile */
	VDEC_DRV_MPEG_VIDEO_PROFILE_H263_0                = (1 << 2),   /* /< H263 Profile 0 */
	VDEC_DRV_MPEG_VIDEO_PROFILE_H263_1                = (1 << 3),   /* /< H263 Profile 1 */
	VDEC_DRV_MPEG_VIDEO_PROFILE_H263_2                = (1 << 4),   /* /< H263 Profile 2 */
	VDEC_DRV_MPEG_VIDEO_PROFILE_H263_3                = (1 << 5),   /* /< H263 Profile 3 */
	VDEC_DRV_MPEG_VIDEO_PROFILE_H263_4                = (1 << 6),   /* /< H263 Profile 4 */
	VDEC_DRV_MPEG_VIDEO_PROFILE_H263_5                = (1 << 7),   /* /< H263 Profile 5 */
	VDEC_DRV_MPEG_VIDEO_PROFILE_H263_6                = (1 << 8),   /* /< H263 Profile 6 */
	VDEC_DRV_MPEG_VIDEO_PROFILE_H263_7                = (1 << 9),   /* /< H263 Profile 7 */
	VDEC_DRV_MPEG_VIDEO_PROFILE_H263_8                = (1 << 10),  /* /< H263 Profile 8 */
	VDEC_DRV_MPEG_VIDEO_PROFILE_MPEG2_SIMPLE          = (1 << 11),  /* /< MPEG2 Simple Profile */
	VDEC_DRV_MPEG_VIDEO_PROFILE_MPEG2_MAIN            = (1 << 12),  /* /< MPEG2 Main Profile */
	VDEC_DRV_MPEG_VIDEO_PROFILE_MPEG2_SNR             = (1 << 13),  /* /< MPEG2 SNR Profile */
	VDEC_DRV_MPEG_VIDEO_PROFILE_MPEG2_SPATIAL         = (1 << 14),  /* /< MPEG2 Spatial Profile */
	VDEC_DRV_MPEG_VIDEO_PROFILE_MPEG2_HIGH            = (1 << 15)   /* /< MPEG2 High Profile */
} VDEC_DRV_MPEG_VIDEO_PROFILE_T;
...
/**
 * @par Enumeration
 *  VDEC_DRV_VP9_VIDEO_PROFILE_T
 * @par Description
 *  video profile for VP9
 */
typedef enum _VDEC_DRV_VP9_VIDEO_PROFILE_T {
	VDEC_DRV_VP9_VIDEO_PROFILE_UNKNOWN    = 0,            /* /< Unknown video profile */
	VDEC_DRV_VP9_VIDEO_PROFILE_0          = (1 << 0),     /* /< 8 bit sample/4:2:0 */
	VDEC_DRV_VP9_VIDEO_PROFILE_1          = (1 << 1),     /* /< 8 bit/4:2:2, 4:4:4 */
	VDEC_DRV_VP9_VIDEO_PROFILE_2          = (1 << 2),     /* /< 10 or 12 bit/4:2:0 */
	VDEC_DRV_VP9_VIDEO_PROFILE_3          = (1 << 3),      /* /< 10 or 12 bit/4:2:2, 4:4:4 */
	VDEC_DRV_VP9_VIDEO_PROFILE_2_HDR      = (1 << 4),
	VDEC_DRV_VP9_VIDEO_PROFILE_3_HDR      = (1 << 5)
} VDEC_DRV_VP9_VIDEO_PROFILE_T;
...
typedef enum _VDEC_DRV_VIDEO_LEVEL_T {
	...
	VDEC_DRV_VIDEO_LEVEL_RV40                  /* /< Specified by realvideo, rv40 */
...
typedef enum _VDEC_DRV_QUERY_TYPE_T {
	...
	VDEC_DRV_QUERY_TYPE_FRAME_LAYOUT,         /* /< Query VDEC_DRV_QUERY_TYPE_FRAME_LAYOUT */
	VDEC_DRV_QUERY_TYPE_SUPPORTED_FORMATS,  /* /< Query VDEC_DRV_QUERY_TYPE_SUPPORTED_FORMATS */
	VDEC_DRV_QUERY_TYPE_FRAME_SIZES,        /* /< Query VDEC_DRV_QUERY_TYPE_FRAME_SIZES */
} VDEC_DRV_QUERY_TYPE_T;
...
typedef enum _VDEC_DRV_GET_TYPE_T {
	...
	*/
	...
	VDEC_DRV_GET_TYPE_GET_WAIT_KEYFRAME,            /* /< set wait keyframe mode, default 0, 1 = wait at start/flush, 2 = wait at seek mode, 3 = always wait*/
	VDEC_DRV_GET_TYPE_CODEC_PROPERTY,               /* /< get teh codec specific property for decode flow*/
	VDEC_DRV_GET_TYPE_GET_COLOR_DESC,
	VDEC_DRV_GET_TYPE_ERRORMB_MAP,
	VDEC_DRV_GET_TYPE_NEED_LEGACY_MODE,
	VDEC_DRV_GET_TYPE_NEED_RESET_CURRENT_TIME,
	VDEC_DRV_GET_TYPE_GPU_SUPPORT_BLOCK,
	VDEC_DRV_GET_TYPE_PROFILEORLEVELCHANGED,
	VDEC_DRV_GET_TYPE_SUPPORT_SVP_LEGACY,
	VDEC_DRV_GET_TYPE_GET_ASPECT_RATIO
} VDEC_DRV_GET_TYPE_T;
...
typedef enum _VDEC_DRV_PIXEL_FORMAT_T {
	...
	VDEC_DRV_PIXEL_FORMAT_YUV_420_PLANER_UFO_10BIT_H, /* /< YUV 420 planer MTK 10 bit v UFO mode */
	VDEC_DRV_PIXEL_FORMAT_YUV_420_PLANER_UFO_10BIT_V, /* /< YUV 420 planer MTK 10 bit h UFO mode */
	VDEC_DRV_PIXEL_FORMAT_YUV_YV12,                   /* /< YUV YV12 */
	VDEC_DRV_PIXEL_FORMAT_YUV_NV12,                   /* /< YUV NV12 */
	VDEC_DRV_PIXEL_FORMAT_YUV_420_PLANER_UFO_AUO,          /* /< YUV 420 planer MTK UFO AUO mode */
	VDEC_DRV_PIXEL_FORMAT_YUV_420_PLANER_UFO_10BIT_H_JUMP, /* /< YUV 420 planer MTK 10 bit v UFO JUMP mode */
	VDEC_DRV_PIXEL_FORMAT_YUV_420_PLANER_UFO_10BIT_V_JUMP, /* /< YUV 420 planer MTK 10 bit h UFO JUMP mode */
	VDEC_DRV_PIXEL_FORMAT_YUV_420_PLANER_MTK_10BIT_H_JUMP, /* /< YUV 420 planer MTK 10 bit blk v mode */
	VDEC_DRV_PIXEL_FORMAT_YUV_420_PLANER_MTK_10BIT_V_JUMP, /* /< YUV 420 planer MTK 10 bit blk h mode */
} VDEC_DRV_PIXEL_FORMAT_T;
...
enum mtk_frame_layout {
	VDEC_DRV_UFO_ON = (1 << 0),
	VDEC_DRV_UFO_AUO_ON = (1 << 1),
	VDEC_DRV_JUMP_ON = (1 << 2),
};
...
typedef enum _VDEC_DRV_SET_TYPE_T {
	...
	VDEC_DRV_SET_TYPE_FREE_INPUT_BFFER,             /* /< set input buffer to free input buffer array */
	...
	VDEC_DRV_SET_TYPE_SET_FRAME_SIZE,                /* /< set frame size from caller for MPEG4 decoder */

	/* /< use the max suppoerted size as output buffer size. for smooth */
	VDEC_DRV_SET_TYPE_SET_FIXEDMAXOUTPUTBUFFER,
	VDEC_DRV_SET_TYPE_SET_DECODE_LAYOUT,
	VDEC_DRV_SET_TYPE_SET_CALLBACK,
	VDEC_DRV_SET_TYPE_SET_FULL_SPEED,
	VDEC_DRV_SET_TYPE_SET_KERNEL_LOG_COUNT,
	VDEC_DRV_SET_TYPE_SET_VIDEO_INFO,
	VDEC_DRV_SET_TYPE_SET_WAIT_ISR_CB,                  /* set for v4l2 vpud sent msg*/
	VDEC_DRV_SET_TYPE_SET_LOG_LEVEL_DBG,
	VDEC_DRV_SET_TYPE_SET_NALSIZELENGTH,            /*/< use the length of NAL size to 0, 2, 4 bytes. */
	...
	VDEC_DRV_SET_TYPE_SET_AV_TASK_GROUP,            /* /< set av task group mode 0 = off, 1 = on */
	VDEC_DRV_SET_TYPE_SET_OUTPUT_BUF_INDEX,        /* /< set output buffer index */
	VDEC_DRV_SET_TYPE_SET_TOTAL_OUTPUT_BUF_SIZE,        /* /< set total output buffer size */
	VDEC_DRV_SET_TYPE_SET_OPERATING_RATE
} VDEC_DRV_SET_TYPE_T;
...
typedef enum _VDEC_DRV_DECODE_MODE_T {
	...
	VDEC_DRV_DECODE_MODE_SEEK,
	VDEC_DRV_DECODE_MODE_DROP_ERROR_FRAME,
} VDEC_DRV_DECODE_MODE_T;
...
typedef enum __VDEC_DRV_MRESULT_T {
	...
	VDEC_DRV_MRESULT_NEED_SEQ_HEADER,
...
typedef struct __VDEC_DRV_FRAMEBUF_T {
	...
	VAL_MEM_ADDR_T  rBaseAddrPlanes[8];         /* /< [IN/OUT] Multi planes base address */
	VAL_UINT32_T    u4PlanesNum;                /* /< [IN] Number of planes */
	VAL_UINT32_T    u4Index;                    /* /< [IN] frame buffer index in vb2 queue */
...
typedef struct __VDEC_DRV_PICINFO_T {
	...
	VAL_BOOL_T      bHDRColorDesc;           /* /< [OUT] Seqence has extra HDR color description */
} VDEC_DRV_PICINFO_T;
...
typedef struct __VDEC_DRV_SEQINFO_T {
	...
	VAL_BOOL_T      bIsThumbnail;               /* /< [IN] check thumbnail */
	VAL_BOOL_T      bIsMinWorkBuffer;           /* /< [IN] check slim memory working buffer */
	VAL_BOOL_T      bIsMinDpbStrategy;          /* /< [IN] check using min getDpbSize strategy */
	VAL_INT32_T     u4BitDepthLuma;             /* /< [OUT] Sequence luma bitdepth */
	VAL_INT32_T     u4BitDepthChroma;           /* /< [OUT] Sequence chroma bitdepth */
	VAL_BOOL_T      bIsHorizontalScaninLSB;     /* /< [OUT] Scan direction in 10bit LSB 2 bit */
	VAL_BOOL_T      bHDRColorDesc;           /* /< [OUT] Seqence has extra HDR color description */
...
/**
 * @par Structure
 *  VDEC_DRV_COLORDESC_T
 * @par Description
 *  Sequence HDR color range description.
 */
typedef struct __VDEC_DRV_COLORDESC_T {
       ...
       */
	VAL_UINT32_T u4ColorPrimaries; // colour_primaries emum
	VAL_UINT32_T u4TransformCharacter; // transfer_characteristics emum
	VAL_UINT32_T u4MatrixCoeffs; // matrix_coeffs emum
	VAL_UINT32_T u4DisplayPrimariesX[3]; // display_primaries_x
	VAL_UINT32_T u4DisplayPrimariesY[3]; // display_primaries_y
	VAL_UINT32_T u4WhitePointX; // white_point_x
	VAL_UINT32_T u4WhitePointY; // white_point_y
	VAL_UINT32_T u4MaxDisplayMasteringLuminance; // max_display_mastering_luminance
	VAL_UINT32_T u4MinDisplayMasteringLuminance; // min_display_mastering_luminance
	VAL_UINT32_T u4MaxContentLightLevel;
	VAL_UINT32_T u4MaxPicAverageLightLevel;
        /* shared with /vendor/mediatek/proprietary/hardware/dpframework/include/DpDataType.h
            DP_VDEC_DRV_COLORDESC_T must be sync
        */
	VAL_UINT32_T u4IsHDR;
	VAL_UINT32_T u4FullRange;  // video full range flag
} VDEC_DRV_COLORDESC_T;
...
/**
* @par Structure
* VDEC_DRV_FIXED_MAX_OUTPUT_BUFFER_T
* @par Description
* Fixed MAX output buffer settings
*/
typedef struct _VDEC_DRV_FIXED_MAX_OUTPUT_BUFFER_T_ {
    VAL_UINT32_T u4MaxWidth;
    VAL_UINT32_T u4MaxHeight;
} VDEC_DRV_FIXED_MAX_OUTPUT_BUFFER_T;
typedef VDEC_DRV_FIXED_MAX_OUTPUT_BUFFER_T * P_VDEC_DRV_FIXED_MAX_OUTPUT_BUFFER_T;

/**
 * @par Structure
 *  VDEC_DRV_SET_TYPE_SET_VIDEO_INFO
 * @par Description
 *  [Unused]Set video-related info
 */
typedef struct __VDEC_DRV_SET_VIDEO_INFO_T {
    VAL_UINT32_T            u4fps;
    VAL_UINT32_T            u4Width;
    VAL_UINT32_T            u4Height;
} VDEC_DRV_SET_VIDEO_INFO_T;

/**
 * @par Structure
 * VDEC_DRV_HW_CAP_INFO_T
 * @par Description
 * set vdec hw capability info
 */
typedef struct __VDEC_DRV_HW_CAP_INFO_T {
    VAL_DRIVER_TYPE_T eVdecDrvType;
    VAL_UINT32_T u4MinPicWidth;
    VAL_UINT32_T u4MinPicHeight;
    VAL_UINT32_T u4MaxPicWidth;
    VAL_UINT32_T u4MaxPicHeight;
    VAL_UINT32_T u4BitdepthLuma;
    VAL_UINT32_T u4BitdepthChroma;
