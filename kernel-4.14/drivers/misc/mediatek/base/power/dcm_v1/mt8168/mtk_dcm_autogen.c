...
bool dcm_dramc_ch0_top0_ddrphy_is_on(void)
{
	...
	ret &= ((reg_read(DRAMC_CH0_TOP0_DDRPHY_WO_PLL_MISC_CG_CTRL0) &
		DRAMC_CH0_TOP0_DDRPHY_REG0_MASK) ==
		(unsigned int) DRAMC_CH0_TOP0_DDRPHY_REG0_ON);
	ret &= ((reg_read(DRAMC_CH0_TOP0_DDRPHY_WO_PLL_MISC_CG_CTRL2) &
		DRAMC_CH0_TOP0_DDRPHY_REG1_MASK) ==
		(unsigned int) DRAMC_CH0_TOP0_DDRPHY_REG1_ON);
	ret &= ((reg_read(DRAMC_CH0_TOP0_DDRPHY_WO_PLL_MISC_CTRL3) &
...
void dcm_dramc_ch0_top0_ddrphy(int on)
{
	if (on) {
		...
		reg_write(DRAMC_CH0_TOP0_DDRPHY_WO_PLL_MISC_CG_CTRL0,
			(reg_read(DRAMC_CH0_TOP0_DDRPHY_WO_PLL_MISC_CG_CTRL0) &
			~DRAMC_CH0_TOP0_DDRPHY_REG0_MASK) |
			DRAMC_CH0_TOP0_DDRPHY_REG0_ON);
		reg_write(DRAMC_CH0_TOP0_DDRPHY_WO_PLL_MISC_CG_CTRL2,
			(reg_read(DRAMC_CH0_TOP0_DDRPHY_WO_PLL_MISC_CG_CTRL2) &
			~DRAMC_CH0_TOP0_DDRPHY_REG1_MASK) |
			DRAMC_CH0_TOP0_DDRPHY_REG1_ON);
		reg_write(DRAMC_CH0_TOP0_DDRPHY_WO_PLL_MISC_CTRL3,
			(reg_read(DRAMC_CH0_TOP0_DDRPHY_WO_PLL_MISC_CTRL3) &
			~DRAMC_CH0_TOP0_DDRPHY_REG2_MASK) |
...
bool dcm_dramc_ch1_top0_ddrphy_is_on(void)
{
	...
	ret &= ((reg_read(DRAMC_CH1_TOP0_DDRPHY_PLL_CHB_MISC_CG_CTRL0) &
		DRAMC_CH1_TOP0_DDRPHY_REG0_MASK) ==
		(unsigned int) DRAMC_CH1_TOP0_DDRPHY_REG0_ON);
	ret &= ((reg_read(DRAMC_CH1_TOP0_DDRPHY_PLL_CHBMISC_CG_CTRL2) &
		DRAMC_CH1_TOP0_DDRPHY_REG1_MASK) ==
		(unsigned int) DRAMC_CH1_TOP0_DDRPHY_REG1_ON);
	ret &= ((reg_read(DRAMC_CH1_TOP0_DDRPHY_PLL_CHBMISC_CTRL3) &
...
void dcm_dramc_ch1_top0_ddrphy(int on)
{
	if (on) {
		...
		reg_write(DRAMC_CH1_TOP0_DDRPHY_PLL_CHB_MISC_CG_CTRL0,
			(reg_read(DRAMC_CH1_TOP0_DDRPHY_PLL_CHB_MISC_CG_CTRL0) &
			~DRAMC_CH1_TOP0_DDRPHY_REG0_MASK) |
			DRAMC_CH1_TOP0_DDRPHY_REG0_ON);
		reg_write(DRAMC_CH1_TOP0_DDRPHY_PLL_CHBMISC_CG_CTRL2,
			(reg_read(DRAMC_CH1_TOP0_DDRPHY_PLL_CHBMISC_CG_CTRL2) &
			~DRAMC_CH1_TOP0_DDRPHY_REG1_MASK) |
			DRAMC_CH1_TOP0_DDRPHY_REG1_ON);
		reg_write(DRAMC_CH1_TOP0_DDRPHY_PLL_CHBMISC_CTRL3,
			(reg_read(DRAMC_CH1_TOP0_DDRPHY_PLL_CHBMISC_CTRL3) &
			~DRAMC_CH1_TOP0_DDRPHY_REG2_MASK) |
