...
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(MT6390_BUCK_VPROC_OP_EN,
...
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(MT6390_BUCK_VCORE_OP_EN,
...
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(MT6390_BUCK_VMODEM_OP_EN,
...
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(MT6390_BUCK_VS1_OP_EN,
...
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(MT6390_LDO_VSRAM_PROC_OP_EN,
...
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(MT6390_LDO_VSRAM_OTHERS_OP_EN,
...
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(MT6390_LDO_VFE28_OP_EN,
...
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(MT6390_LDO_VXO22_OP_EN,
...
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(MT6390_LDO_VRF18_OP_EN,
...
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(MT6390_LDO_VRF12_OP_EN,
...
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(MT6390_LDO_VEFUSE_OP_EN,
		      ...
		      unsigned char op_en, unsigned char op_cfg)
{
	...
	PMICLOG("%s\n", __func__);
	ret = pmic_lp_type_set(MT6390_LDO_VCN33_OP_EN,
...
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(MT6390_LDO_VCN28_OP_EN,
...
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(MT6390_LDO_VCN18_OP_EN,
...
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(MT6390_LDO_VCAMA_OP_EN,
...
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(MT6390_LDO_VCAMD_OP_EN,
...
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(MT6390_LDO_VCAMIO_OP_EN,
		       ...
		       unsigned char op_en, unsigned char op_cfg)
{
	...
	PMICLOG("%s\n", __func__);
	ret = pmic_lp_type_set(MT6390_LDO_VLDO28_OP_EN,
...
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(MT6390_LDO_VAUX18_OP_EN,
...
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(MT6390_LDO_VAUD28_OP_EN,
...
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(MT6390_LDO_VIO28_OP_EN,
...
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(MT6390_LDO_VIO18_OP_EN,
...
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(MT6390_LDO_VDRAM_OP_EN,
...
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(MT6390_LDO_VMC_OP_EN,
...
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(MT6390_LDO_VMCH_OP_EN,
...
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(MT6390_LDO_VEMC_OP_EN,
...
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(MT6390_LDO_VSIM1_OP_EN,
...
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(MT6390_LDO_VSIM2_OP_EN,
...
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(MT6390_LDO_VIBR_OP_EN,
		       ...
		       unsigned char op_en, unsigned char op_cfg)
{
	...
	PMICLOG("%s\n", __func__);
	ret = pmic_lp_type_set(MT6390_LDO_VUSB33_OP_EN,
...
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(MT6390_LDO_TREF_OP_EN,
