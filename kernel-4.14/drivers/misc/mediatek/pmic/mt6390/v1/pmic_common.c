...
const PMU_FLAG_TABLE_ENTRY pmu_flags_table[] = {
	...
	PMIC_ENTRY(PMIC_STRUP_VFE28_PG_STATUS),
	PMIC_ENTRY(PMIC_VRF12_PG_DEB),
	PMIC_ENTRY(PMIC_VFE28_PG_DEB),
	...
	PMIC_ENTRY(PMIC_RG_RTC_32K1V8_1_SEL),
	...
	PMIC_ENTRY(PMIC_SRCLKEN_IN0),
	PMIC_ENTRY(PMIC_SRCLKEN_IN1),
	PMIC_ENTRY(PMIC_SRCLKEN_IN2),
	...
	PMIC_ENTRY(PMIC_RGS_VUSB33_PG_STATUS),
	PMIC_ENTRY(PMIC_RGS_VAUD28_PG_STATUS),
	PMIC_ENTRY(PMIC_RGS_VFE28_PG_STATUS),
	...
	PMIC_ENTRY(PMIC_RGS_VDRAM_PG_STATUS),
	...
	PMIC_ENTRY(PMIC_RGS_VPROC_PG_STATUS),
	PMIC_ENTRY(PMIC_RGS_VEMC_PG_STATUS),
	PMIC_ENTRY(PMIC_RGS_VIO28_PG_STATUS),
	...
	PMIC_ENTRY(PMIC_RG_VFE28_DSA),
	PMIC_ENTRY(PMIC_PSC_TOP_ELR_LEN),
	PMIC_ENTRY(PMIC_RG_PSC_TOP_RSV),
	...
	PMIC_ENTRY(PMIC_RG_STRUP_VFE28_PG_H2L_EN),
	PMIC_ENTRY(PMIC_RG_STRUP_VRF12_PG_H2L_EN),
	PMIC_ENTRY(PMIC_RG_STRUP_VIO28_PG_H2L_EN),
	...
	PMIC_ENTRY(PMIC_RG_STRUP_VFE28_PG_ENB),
	...
	PMIC_ENTRY(PMIC_RG_VFE28_PSRR_ENHANCE),
	...
	PMIC_ENTRY(PMIC_PDN_AFE_DL_PREDIST_CTL),
	...
	PMIC_ENTRY(PMIC_R_AUD_DAC_SGEN_SW_RSTB),
