...
#define LOG_2 cam_pr_debug(\
	"preview 960p@30fps; video 960p@30fps; capture 5M@15fps,420Mbps/lane\n")
/***************************   Modify end    ********************************/
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] = {
	{ 2624, 1956,      0,    0, 2624, 1956, 1312,  978,      8,   4,
		1296,  972,  4,    8, 1280,  960},	/* Preview */
	{ 2624, 1956,      0,    0, 2624, 1956, 2624, 1956,     16,   6,
		2592, 1944,  2,    2, 2560,  1920},	/* capture */
	{ 2624, 1956,      0,    0, 2624, 1956, 2592, 1944,      0,   0,
		1296,  972,  4,    8, 1280,  960},	/* video */
	{ 2624, 1956,    336,  434, 1952, 1088, 1952, 1088,     16,   4,
		1920, 1080,  0,    0, 1920,  1080},	/* hight speed video */
	{ 2624, 1956,     16,  254, 2592, 1448, 1296,  724,      8,   2,
		1280,  720,  0,    0, 1280,  720}       /* slim video */
};
 ...
 *
 * DESCRIPTION
 *    This function write e-shutter of sensor to change exposure time.
 *
 * PARAMETERS
...
static void capture_setting(kal_uint16 currefps)
{
	...
	write_cmos_sensor(0x380c,
		((imgsensor_info.cap.linelength >> 8) & 0xFF));
	write_cmos_sensor(0x380d,
		(imgsensor_info.cap.linelength & 0xFF));
	write_cmos_sensor(0x380e,
		((imgsensor_info.cap.framelength >> 8) & 0xFF));
	write_cmos_sensor(0x380f,
		(imgsensor_info.cap.framelength & 0xFF));
...
static void video_1080p_setting(void)
{
	...
	write_cmos_sensor(0x380d,
		(imgsensor_info.hs_video.linelength & 0xFF));
	write_cmos_sensor(0x380e,
		((imgsensor_info.hs_video.framelength >> 8) & 0xFF));
	write_cmos_sensor(0x380f,
		(imgsensor_info.hs_video.framelength & 0xFF));
