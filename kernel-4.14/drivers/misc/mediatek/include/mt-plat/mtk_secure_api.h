...
#define MTK_SIP_KERNEL_EMIMPU_REGION_SET \
...
#define emi_mpu_smc_region_protect(start, end, region, apc) \
mt_secure_call(MTK_SIP_KERNEL_EMIMPU_REGION_SET, start, end, region, apc)
