...
enum {
	FPSGO_DEBUG_MANDATORY = (1U << 0),
	FPSGO_DEBUG_FBT_GM    = (1U << 1),
	FPSGO_DEBUG_FBT_UX    = (1U << 2),
	FPSGO_DEBUG_FSTB      = (1U << 3),
	FPSGO_DEBUG_XGF       = (1U << 4),
	FPSGO_DEBUG_NTFR      = (1U << 5),
	FPSGO_DEBUG_MAX       = (1U << 6)
};
