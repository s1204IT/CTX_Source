...
static unsigned int GPIO_LCD_VDD_EN;
...
{
	GPIO_LCD_VDD_EN = of_get_named_gpio(dev->of_node, "gpio_lcd_vdd_en", 0);
	gpio_request(GPIO_LCD_VDD_EN, "GPIO_LCD_VDD_EN");
...
static void lcm_suspend_power(void)
{
	...
	lcm_set_gpio_output(GPIO_LCD_VDD_EN, GPIO_OUT_ZERO);
	MDELAY(10);
