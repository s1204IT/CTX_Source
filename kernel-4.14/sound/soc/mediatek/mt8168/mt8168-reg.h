/*
 * mt8168-reg.h  --  Mediatek 8168 audio driver reg definition
 *
...
#ifndef _MT8168_REG_H_
#define _MT8168_REG_H_
...
/* AFE_ADDA_UL_DL_CON0 */
#define AFE_ADDA_UL_DL_ADDA_AFE_ON_MASK		BIT(0)
#define AFE_ADDA_UL_DL_ADDA_AFE_ON		(1 << 0)
#define AFE_ADDA_UL_DL_ADDA_AFE_OFF		(0 << 0)
#define AFE_ADDA_UL_DL_DMIC_CLKDIV_ON_MASK	BIT(1)
#define AFE_ADDA_UL_DL_DMIC_CLKDIV_ON	(1 << 1)
#define AFE_ADDA_UL_DL_DMIC_CLKDIV_OFF	(0 << 1)

/* AFE_SINEGEN_CON0 (0x01f0) */
#define AFE_SINEGEN_CON0_EN			BIT(26)
#define AFE_SINEGEN_CON0_IN_OUT_SEL		BIT(27)
#define AFE_SINEGEN_CON0_MODE_MASK		GENMASK(31, 28)
#define AFE_SINEGEN_CON0_AMP_DIV_CH2_MASK	GENMASK(19, 17)
#define AFE_SINEGEN_CON0_AMP_DIV_CH1_MASK	GENMASK(7, 5)
#define AFE_SINEGEN_CON0_AMP_DIV_CH2(x)	(((x) & 0x7) << 17)
#define AFE_SINEGEN_CON0_AMP_DIV_CH1(x)	(((x) & 0x7) << 5)
...
#define AFE_SINEGEN_CON0_TIMING_CH2_MASK	GENMASK(23, 20)
#define AFE_SINEGEN_CON0_TIMING_CH1_MASK	GENMASK(11, 8)
#define AFE_SINEGEN_CON0_TIMING_CH2(x)		(((x) & 0xf) << 20)
#define AFE_SINEGEN_CON0_TIMING_CH1(x)		(((x) & 0xf) << 8)
#define AFE_SINEGEN_CON0_TIMING_8K			(0)
#define AFE_SINEGEN_CON0_TIMING_11D025K		(1)
#define AFE_SINEGEN_CON0_TIMING_12K			(2)
#define AFE_SINEGEN_CON0_TIMING_16K			(4)
#define AFE_SINEGEN_CON0_TIMING_22D05K		(5)
#define AFE_SINEGEN_CON0_TIMING_24K			(6)
#define AFE_SINEGEN_CON0_TIMING_32K			(8)
#define AFE_SINEGEN_CON0_TIMING_44D1K		(9)
#define AFE_SINEGEN_CON0_TIMING_48K			(10)
#define AFE_SINEGEN_CON0_TIMING_88D2K		(11)
#define AFE_SINEGEN_CON0_TIMING_96K			(12)
#define AFE_SINEGEN_CON0_TIMING_176D4K		(13)
#define AFE_SINEGEN_CON0_TIMING_192K		(14)
...
#define PCM_INTF_CON1_EXT_MODEM			(1 << 17)
...
/* AFE_TDM_IN_CON2 (0x058c) */
#define AFE_TDM_IN_CON2_DISABLE_CH01		BIT(0)
#define AFE_TDM_IN_CON2_DISABLE_CH23		BIT(1)
#define AFE_TDM_IN_CON2_DISABLE_CH45		BIT(2)
#define AFE_TDM_IN_CON2_DISABLE_CH67		BIT(3)

/* AFE_DMIC0_UL_SRC_CON0 (0x05b4)
 * AFE_DMIC0_UL_SRC_CON0 (0x0620)
 * AFE_DMIC0_UL_SRC_CON0 (0x0780)
 * AFE_DMIC0_UL_SRC_CON0 (0x07ec)
 */
#define DMIC_TOP_CON_DMIC_TWO_WIRE_MODE			BIT(23)
#define DMIC_TOP_CON_DMIC_CK_PHASE_SEL_CH2(x)		((x) << 24)
#define DMIC_TOP_CON_DMIC_CK_PHASE_SEL_CH1(x)		((x) << 27)
#define DMIC_TOP_CON_DMIC_CH2_ON_MASK			BIT(22)
#define DMIC_TOP_CON_DMIC_CH2_ON			(1 << 22)
#define DMIC_TOP_CON_DMIC_CH2_OFF			(0 << 22)
#define DMIC_TOP_CON_DMIC_CH1_ON_MASK			BIT(21)
#define DMIC_TOP_CON_DMIC_CH1_ON			(1 << 21)
#define DMIC_TOP_CON_DMIC_CH1_OFF			(0 << 21)
#define DMIC_TOP_CON_DMIC_VOICE_MODE_8K			(0 << 17)
#define DMIC_TOP_CON_DMIC_VOICE_MODE_16K		(1 << 17)
#define DMIC_TOP_CON_DMIC_VOICE_MODE_32K		(2 << 17)
#define DMIC_TOP_CON_DMIC_VOICE_MODE_48K		(3 << 17)
#define DMIC_TOP_CON_DMIC_NO_LOW_POWER_MODE		(0 << 14)
#define DMIC_TOP_CON_DMIC_LOW_POWER_MODE(x)		((x) << 14)
#define DMIC_TOP_CON_DMIC_IIR_ON			BIT(10)
#define DMIC_TOP_CON_DMIC_INPUT_MODE(x)			((x) << 5)
#define DMIC_TOP_CON_DMIC_IIR_MODE(x)			((x) << 7)
#define DMIC_TOP_CON_DMIC_SDM3_LEVEL_MODE		BIT(1)
...
#define TDM_ASRC_OUT_MODE(x)		((x) << 4)
#define TDM_ASRC_OUT_MODE_MASK		GENMASK(7, 4)
#define TDM_ASRC_OUT_SEL			BIT(2)
#define TDM_ASRC_OUT_SEL_TO_CM1		(0 << 2)
#define TDM_ASRC_OUT_SEL_TO_CM2		(1 << 2)
#define TDM_ASRC_IN_SEL_FROM_TDMIN	(0 << 1)
#define TDM_ASRC_IN_SEL_FROM_TDMOUT	(1 << 1)
#define TDM_ASRC_IN_SEL_MASK		BIT(1)
#define TDM_ASRC_EN_ON		BIT(0)
...
#define AFE_22M_PLL_ON		(1 << 0)
#define AFE_22M_PLL_OFF		(0 << 0)
...
/* AFE_CM1_CON0 (0x0e50) */
/* AFE_CM2_CON0 (0x0e60) */
#define CM_AFE_CM_CH_NUM(x)				(((x) - 1) << 0)
#define CM_AFE_CM_CH_NUM_MASK			GENMASK(3, 0)
#define CM_AFE_CM_ON					BIT(4)
#define CM_AFE_CM_OFF					(0 << 4)
#define CM_AFE_CM_START_DATA(x)			((x) << 8)
#define CM_AFE_CM_START_DATA_MASK		GENMASK(11, 8)

#define CM_AFE_CM1_VUL_SEL_CM1_OUTPUT	(0 << 12)
#define CM_AFE_CM1_VUL_SEL_O17_O18		(1 << 12)
#define CM_AFE_CM1_VUL_SEL				BIT(12)
#define CM_AFE_CM1_IN_MODE(x)			((x) << 16)
#define CM_AFE_CM1_IN_MODE_MASK			GENMASK(19, 16)
#define CM_AFE_CM2_TDM_SEL_CM2_OUTPUT	(1 << 12)
#define CM_AFE_CM2_TDM_SEL_TDM			(0 << 12)
#define CM_AFE_CM2_TDM_SEL				BIT(12)
#define CM_AFE_CM2_CLK_SEL_24M			(0 << 13)
#define CM_AFE_CM2_CLK_SEL_22M			(1 << 13)
#define CM_AFE_CM2_CLK_SEL				BIT(13)
#define CM_AFE_CM2_GASRC1_OUT_SEL		BIT(17)
#define CM_AFE_CM2_GASRC2_OUT_SEL		BIT(16)
#define GASRC1_OUT_TO_TDM_OUT_EN		(0 << 17)
#define GASRC1_OUT_TO_ENGEN_OUT_EN		(1 << 17)
#define GASRC2_OUT_TO_TDM_OUT_EN		(0 << 16)
#define GASRC2_OUT_TO_ENGEN_OUT_EN		(1 << 16)

/* AFE_CM2_CONN* */
#define CM2_AFE_CM2_CONN_CFG1(x)		((x) << 0)
#define CM2_AFE_CM2_CONN_CFG1_MASK		GENMASK(4, 0)
#define CM2_AFE_CM2_CONN_CFG2(x)		((x) << 5)
#define CM2_AFE_CM2_CONN_CFG2_MASK		GENMASK(9, 5)
#define CM2_AFE_CM2_CONN_CFG3(x)		((x) << 10)
#define CM2_AFE_CM2_CONN_CFG3_MASK		GENMASK(14, 10)
#define CM2_AFE_CM2_CONN_CFG4(x)		((x) << 15)
#define CM2_AFE_CM2_CONN_CFG4_MASK		GENMASK(19, 15)
#define CM2_AFE_CM2_CONN_CFG5(x)		((x) << 20)
#define CM2_AFE_CM2_CONN_CFG5_MASK		GENMASK(24, 20)
#define CM2_AFE_CM2_CONN_CFG6(x)		((x) << 25)
#define CM2_AFE_CM2_CONN_CFG6_MASK		GENMASK(29, 25)
#define CM2_AFE_CM2_CONN_CFG7(x)		((x) << 0)
#define CM2_AFE_CM2_CONN_CFG7_MASK		GENMASK(4, 0)
#define CM2_AFE_CM2_CONN_CFG8(x)		((x) << 5)
#define CM2_AFE_CM2_CONN_CFG8_MASK		GENMASK(9, 5)
#define CM2_AFE_CM2_CONN_CFG9(x)		((x) << 10)
#define CM2_AFE_CM2_CONN_CFG9_MASK		GENMASK(14, 10)
#define CM2_AFE_CM2_CONN_CFG10(x)		((x) << 15)
#define CM2_AFE_CM2_CONN_CFG10_MASK		GENMASK(19, 15)
#define CM2_AFE_CM2_CONN_CFG11(x)		((x) << 20)
#define CM2_AFE_CM2_CONN_CFG11_MASK		GENMASK(24, 20)
#define CM2_AFE_CM2_CONN_CFG12(x)		((x) << 25)
#define CM2_AFE_CM2_CONN_CFG12_MASK		GENMASK(29, 25)
#define CM2_AFE_CM2_CONN_CFG13(x)		((x) << 0)
#define CM2_AFE_CM2_CONN_CFG13_MASK		GENMASK(4, 0)
#define CM2_AFE_CM2_CONN_CFG14(x)		((x) << 5)
#define CM2_AFE_CM2_CONN_CFG14_MASK		GENMASK(9, 5)
#define CM2_AFE_CM2_CONN_CFG15(x)		((x) << 10)
#define CM2_AFE_CM2_CONN_CFG15_MASK		GENMASK(14, 10)
#define CM2_AFE_CM2_CONN_CFG16(x)		((x) << 15)
#define CM2_AFE_CM2_CONN_CFG16_MASK		GENMASK(19, 15)

/* AFE_CM1_CON* */
#define CM_AFE_CM_UPDATE_CNT1(x)		(((x) & (0xffff)) << 0)
#define CM_AFE_CM_UPDATE_CNT2(x)		(((x) & (0xffff)) << 16)
#define CM_AFE_CM_UPDATE_CNT1_MASK		GENMASK(15, 0)
#define CM_AFE_CM_UPDATE_CNT2_MASK		GENMASK(31, 16)
#define CM_AFE_CM_UPDATE_CNT_MASK		GENMASK(31, 0)

/* AFE_CM2_CON0 (0x0e60)*/
#define GASRC_ASRC1_OUT_EN_SEL BIT(17)
#define GASRC_ASRC2_OUT_EN_SEL BIT(16)


/* AFE_GENERAL1_ASRC_2CH_CON0 (0x0e80)
 * AFE_GENERAL2_ASRC_2CH_CON0 (0x0f00)
 */
...
#define GASRC_CON0_CHSET_IIR_EN		BIT(11)
#define GASRC_CON0_CHSET_IIR_STAGE(x)	((x) << 8)
#define GASRC_CON0_CHSET_IIR_STAGE_MASK	GENMASK(10, 8)
#define GASRC_CON0_CHSET_STR_CLR		BIT(4)
#define GASRC_CON0_COEFF_SRAM_CTRL		BIT(1)
#define GASRC_CON0_ASM_ON				BIT(0)

/* GENERAL_ASRC_MODE (0x0eb8) */
#define GASRC_MODE_GASRC1_IN_MODE(x)	(((x) & 0xf) << 0)
#define GASRC_MODE_GASRC2_IN_MODE(x)	(((x) & 0xf) << 8)
#define GASRC_MODE_GASRC1_IN_MODE_MASK	GENMASK(3, 0)
#define GASRC_MODE_GASRC2_IN_MODE_MASK	GENMASK(11, 8)
#define GASRC_MODE_GASRC1_OUT_MODE(x)	(((x) & 0xf) << 4)
#define GASRC_MODE_GASRC2_OUT_MODE(x)	(((x) & 0xf) << 12)
#define GASRC_MODE_GASRC1_OUT_MODE_MASK	GENMASK(7, 4)
#define GASRC_MODE_GASRC2_OUT_MODE_MASK	GENMASK(15, 12)

/* GENERAL_ASRC_EN_ON (0x0ebc) */
#define GASRC_EN_ON_MASK(x)	(0x1 << (x))
#define GASRC_EN_ON(x)		(0x1 << (x))
#define GASRC_EN_OFF(x)		(0x0 << (x))

/* AFE_GENERAL1_ASRC_2CH_CON5 (0x0e94)
 * AFE_GENERAL2_ASRC_2CH_CON5 (0x0f14)
 */
#define GASRC_CON5_CALI_CYCLE_MASK GENMASK(31, 16)
#define GASRC_CON5_CALI_64_CYCLE (0x3F << 16)
#define GASRC_CON5_CALI_96_CYCLE (0x5F << 16)
#define GASRC_CON5_CALI_441_CYCLE (0x1B8 << 16)
#define GASRC_CON5_CALI_AUTORST_ENABLE BIT(15)
#define GASRC_CON5_AUTO_TUNE_FREQ5_ENABLE	BIT(12)
#define GASRC_CON5_AUTO_TUNE_FREQ5_DISABLE	(0x0 << 12)
#define GASRC_CON5_COMP_FREQ_RES_ENABLE		BIT(11)
#define GASRC_CON5_CALI_BP_DGL_BYPASS	BIT(7)
#define GASRC_CON5_AUTO_TUNE_FREQ4_ENABLE	 BIT(3)
#define GASRC_CON5_AUTO_TUNE_FREQ4_DISABLE	(0x0 << 3)
#define GASRC_CON5_CALI_AUTO_RESTART_ENABLE	BIT(2)
#define GASRC_CON5_CALI_USE_FREQ	BIT(1)
#define GASRC_CON5_CALI_USE_PERIOD	(0x0 << 1)
#define GASRC_CON5_CALI_ON	BIT(0)
#define GASRC_CON5_CALI_OFF	(0x0 << 0)
#define GASRC_CON5_CALI_SEL_MASK	GENMASK(9, 8)
#define GASRC_CON5_CALI_SEL_00	(0x0 << 8)
#define GASRC_CON5_CALI_SEL_01	(0x1 << 8)

/* AFE_TDM_GASRC*_ASRC_2CH_CON0 */
#define TDM_ASRC_CON0_ONE_HEART			BIT(31)
